...
@Component({
    ...
    styleUrls: ['newUsercomponent.css']
})

export class NewUserComponent implements OnInit, OnChanges, AfterViewInit {
    cities = [
    ...
    constructor(private formBuilder: FormBuilder, private accounts: AccountslistService) {
    }
                    ...
                    result => {
                        this.accounts.addnewAccount(result['Customer_id'], this.type.value)
                            .subscribe(res => {console.log('subscribe submit', res['result']);
                                    this.showAccountAlert('success-message');}
                                ,
                                error => {
                                    console.log(error);
                                    this.showAccountAlert('error-message');
                                });
                    });
